...
const Form = () => {
    //useState update the state change
    ...
    const dispatch = useDispatch();//allow us to diapatch action
    ...
    return( 
        //<paper> is like <div> with whitish background
        <Paper className={classes.paper}>
            <Form autoComplete = "off" noValidate className={`${classes.root} ${classes.form}`} onSubmit= {handleSubmit}>
                ...
                <Button  variant='contained' color='secdonary' size='small' onClick={clear} fullWidth>clear</Button>
            </Form>
